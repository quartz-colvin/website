...
```{r, out.height="25%", out.width="25%", echo=FALSE, fig.align='center'}
...
```{r, out.height="25%", out.width="25%", echo=FALSE, fig.cap="Gible and Clefable."}
...
Every week I play [Dungeons & Dragons](https://en.wikipedia.org/wiki/Dungeons_%26_Dragons) online with my friends in other states, and I generally try to go to concerts and travel as often as possible. The concerts are usually alternative or metal, but I listen to a lot of different things. 
...
knitr::include_graphics("./images/falafel_ball1.jpg")
knitr::include_graphics("./images/falafel_ball2.jpg")

```

```{r, out.height="25%", out.width="25%", echo=FALSE}
knitr::include_graphics("./images/soup_gouda.jpg")
knitr::include_graphics("./images/falafel_santa.jpg")
knitr::include_graphics("./images/gouda.jpg")
```

```{r, out.height="25%", out.width="25%", echo=FALSE}
knitr::include_graphics("./images/butter_solo.jpg")
knitr::include_graphics("./images/butter_skritches.jpg")
knitr::include_graphics("./images/falafel.jpg")
```

```{r, out.height="25%", out.width="25%", echo=FALSE}
knitr::include_graphics("./images/sesame_climbs.jpg")
knitr::include_graphics("./images/soup_gouda.jpg")
knitr::include_graphics("./images/sesame.jpg")
```

```{r, out.height="25%", out.width="25%", echo=FALSE}
knitr::include_graphics("./images/sesame1.jpg")
knitr::include_graphics("./images/sesame2.jpg")
knitr::include_graphics("./images/happy_gecko.jpg")
```

```{r, out.height="25%", out.width="25%", echo=FALSE}
knitr::include_graphics("./images/typhon.jpg")
knitr::include_graphics("./images/mlem1.jpg")
knitr::include_graphics("./images/echidna.jpg")
```

```{r, out.height="25%", out.width="25%", echo=FALSE}
knitr::include_graphics("./images/castor.jpg")
